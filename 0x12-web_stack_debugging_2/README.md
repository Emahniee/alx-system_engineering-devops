...
2. (Advanced Task) Using what you did for task #1, make your fix short and sweet.
...
You cannot use &&
You cannot use wget
You cannot execute your previous answer file (Do not include the name of the previous script in this on
